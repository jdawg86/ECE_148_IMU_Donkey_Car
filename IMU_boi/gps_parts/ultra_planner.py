...
class Planner():
    ...
    def run(self, heading, d_heading, currLocation, prevLocation, stop_cmd):
        '''
        ...
        #self.steer_cmd = k * (imu_h - desired_h)
        f = float(heading)
        h = float(d_heading)
        self.steer_cmd = 0.4*(f - h)
        print("imu value: {}".format(self.steer_cmd))

        self.throttle_cmd = 0.06
        ...
        print("throttle: {}".format(self.throttle_cmd))
    ...
    def throttle_controller(self, stop_cmd):
        """
